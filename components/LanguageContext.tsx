...
const translations = {
  pt: {
    ...
    'team.bio_pedro': 'Advogado com ampla atuação no núcleo decisório do Poder Executivo federal. Foi Ministro-Chefe da Secretaria-Geral da Presidência da República (2021) e Secretário Especial de Assuntos Jurídicos da Presidência da República (2020–2022).',
    'team.bio_ronald': 'Advogado com cerca de 20 anos de experiência jurídica. Atuou por aproximadamente dez anos como Procurador Federal na Advocacia-Geral da União.',
